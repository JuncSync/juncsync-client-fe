...
const HospitalItem = ({
  ...
  return (
    <div
      className={`w-full flex flex-col bg-white space-y-[12px] rounded-[8px] p-[16px] border-[1px] font-['Pretendard'] cursor-pointer ${
    ...
    >
      ...
      <div className="flex justify-between border-t-[1px] border-[#f1f1f1] text-[#1b1b1b] font-semibold text-[14px] pt-[8px] ">
        ...
        <div className="w-[160px] justify-between align-text-bottom flex space-x-[2px] font-semibold text-[#1b1b1b] text-[14px] ">
